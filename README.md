...
<h3 align="center">Common module for proprietary Geode-solutions OpenGeode modules</h3>
...
Geode-Common is an [OpenGeode](https://github.com/Geode-solutions/OpenGeode) module providing common algorithms.
...
Installing Geode-Conversion is done by using pip command ```pip install Geode-Common``` and add ```import geode_common``` in your Python script.
